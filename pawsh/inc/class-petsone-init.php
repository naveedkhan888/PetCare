...
if (!class_exists('Petsone_Init')){
	...
	class Petsone_Init{
		 ...
		 * If you're building a theme based on petsone, use a find and replace
		 * to change 'petsone' to the name of your theme in all the template files.
		 */
			load_theme_textdomain( 'petsone', get_template_directory() . '/languages' );
			 ...
			 */
			function petsone_theme_add_editor_styles() {
				add_editor_style( 'custom-style.css' );
			}
			add_action( 'admin_init', 'petsone_theme_add_editor_styles' );
			...
			//Custom image size
			add_image_size('petsone-main-blog', 780, 450, true);
			add_image_size('petsone-blog', 336, 207, true);

			// This theme uses wp_nav_menu() in one location.
			register_nav_menus( array(
				'main-menu' => esc_html__( 'Primary Menu', 'petsone' ),
			) );
			...
			add_theme_support( 'custom-background', apply_filters( 'petsone_custom_background_args', array(
			...
			$GLOBALS['content_width'] = apply_filters( 'petsone_content_width', 640 );
		...
		public function widgets_init(){
			...
			register_sidebar( array(
				'name'          => esc_html__( 'Sidebar', 'petsone' ),
				'id'            => 'right-sidebar',
				'description'   => esc_html__( 'Add widgets here.', 'petsone' ),
			...
			$enable_footer_widgets = get_theme_mod('petsone_enable_footer_widgets', true);
			if($enable_footer_widgets == true){
				register_sidebar( array(
					'name'          => esc_html__( 'Footer Widget Area One', 'petsone' ),
					'id'            => 'footer-widget-1',
					'description'   => esc_html__( 'Add Footer  widgets here.', 'petsone' ),
				...
				register_sidebar( array(
					'name'          => esc_html__( 'Footer Widget Area Two', 'petsone' ),
					'id'            => 'footer-widget-2',
					'description'   => esc_html__( 'Add Footer widgets here.', 'petsone' ),
					'before_widget' => '<div id="%1$s" class="footer-widget widget %2$s">',
					'after_widget'  => '</div>',
				...
				register_sidebar( array(
					'name'          => esc_html__( 'Footer Widget Area Three', 'petsone' ),
					'id'            => 'footer-widget-3',
					'description'   => esc_html__( 'Add Footer widgets here.', 'petsone' ),
					'before_widget' => '<div id="%1$s" class="footer-widget widget %2$s">',
					'after_widget'  => '</div>',
				...
				register_sidebar( array(
					'name'          => esc_html__( 'Footer Widget Area Four', 'petsone' ),
					'id'            => 'footer-widget-4',
					'description'   => esc_html__( 'Add Footer widgets here.', 'petsone' ),
					'before_widget' => '<div id="%1$s" class="footer-widget widget %2$s">',
					'after_widget'  => '</div>',
			...
			register_sidebar( array(
				'name'          => esc_html__( 'Footer Menu Widget', 'petsone' ),
				'id'            => 'footer-menu',
				'description'   => esc_html__( 'Add Footer widgets here.', 'petsone' ),
		...
		public function include_files(){
			...
			$includes_files = array(
				...
				array(
					...
					'file-path' => PETSONE_INC
				),
			
				array(
					'file-name' => 'theme-inline-styles',
					'file-path' => PETSONE_THEME_STYLESHEETS
				),
			);
		...
		*petsone load font
		*/
	   	public static function  petsone_fonts_url() {
	        $font_url = '';
	        if ( 'off' !== esc_html_x( 'on', 'Google font: on or off', 'petsone' ) ) :
	            $font_url = add_query_arg(
	                array(
	                    'family' => urlencode( 'Jost:300,400,500,600|Jost:600,700&display=swap' ),
	                ), "//fonts.googleapis.com/css" );
	        endif;
	        return apply_filters( 'petsone_google_font_url', esc_url( $font_url ) );
	    }
		...
		public function theme_css(){
			...
			$includes_css = array(
				...
				array(
					'handle' => 'bootstrap',
					'src' => PETSONE_CSS .'/bootstrap.min.css',
					'deps' => array(),
					'ver' => $ver,
					'media' => 'all'
				),
				...
				array(
					'handle' => 'font-awesome',
					'src' => PETSONE_CSS .'/font-awesome.min.css',
					'deps' => array(),
					'ver' => $ver,
					'media' => 'all'
				),
				array(
					'handle' => 'jquery-ui',
					'src' => PETSONE_CSS .'/jquery-ui.min.css',
					'deps' => array(),
					'ver' => $ver,
					'media' => 'all'
				),
				...
				array(
					...
					'src' => PETSONE_CSS .'/magnific-popup.css',
					'deps' => array(),
					'ver' => $ver,
					'media' => 'all'
				),
				array(
					'handle' => 'nice-select',
					'src' => PETSONE_CSS .'/nice-select.css',
					'deps' => array(),
					'ver' => $ver,
					'media' => 'all'
				),
			...
			wp_enqueue_style( 'petsone-style', get_stylesheet_uri());
		}
